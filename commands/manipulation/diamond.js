...
module.exports.run = async (bot, message, args) => {
    ...
    var mask = jimp.read("./inputfile/diamond.png");
    ...
    await Promise.all([imgUsuario, mask]).then(function (images) {
        ...
        usuario.mask(mask, 0, 0).write('./outputfile/imgusuariod.png');
    });

    await message.channel.send('<:imagem:492036737019674644> **Sua imagem:**')
    await message.channel.sendFile('./outputfile/imgusuariod.png');

    await fs.unlink('./outputfile/imgusuariod.png');
}
